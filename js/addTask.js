...
function saveTaskToBackend() {
    ...
    document.getElementById('notice-success').classList.remove('d-none');
}
...
function removeNotice() {
    document.getElementById('notice-success').classList.add('d-none');
}
